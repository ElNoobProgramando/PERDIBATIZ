...
public class PubliPerdido {
    ...
    public PubliPerdido(String titulo,String queperdio, String donde, String pgllave, String respu, String luc, String horae, String colors) {
        this.titulo = titulo;
