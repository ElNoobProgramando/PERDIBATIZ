                ...
                con = (Connection)DriverManager.getConnection(url, userName, password);
                        ...
                        try{
                            ...
                            set = con.createStatement();
                             String  q = "INSERT INTO entregado_encontrado (titulos,queperdios,dondeloens,pglla,respuestas,lugars,horarios,fechadepublis,tipos,id_usuarios,entregado) SELECT  titulo,queperdio,dondeloen,pglla,respuesta,lugar,horario,fechadepubli,tipo,id_usuario,'si' FROM encontrado WHERE id_publi = "+original;  
