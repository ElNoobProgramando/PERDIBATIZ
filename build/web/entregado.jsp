                ...
                con = (Connection)DriverManager.getConnection(url, userName, password);
                        ...
                        try{
                            ...
                            set = con.createStatement();
                             String  q = "INSERT INTO entregado_encontrado (titulos,queperdios,dondeloens,pglla,respuestas,lugars,horarios,fechadepublis,tipos,id_usuarios) SELECT  titulo,queperdio,dondeloen,pglla,respuesta,lugar,horario,fechadepubli,tipo,id_usuario FROM encontrado WHERE id_publi = "+original;  
