    ...
    <body>
        ...
        <header class="barraroja">
            ...
            driver = "com.mysql.jdbc.Connection";
                ...
                String sql = "select experiencia, count(experiencia)from no_entregado_encon_experiencias group by experiencia";
                ResultSet rs = cmd.executeQuery(sql);
                System.out.println(rs);
                 try{
                     DefaultPieDataset data = new DefaultPieDataset();
                     while(rs.next()){
                         data.setValue(rs.getString("experiencia"), rs.getInt(2));
                     }
