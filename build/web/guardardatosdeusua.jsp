                ...
                con = DriverManager.getConnection(url, userName, password);
                 if(String.valueOf(session.getAttribute("id")) == null || String.valueOf(session.getAttribute("id")) == "null")
                   ...
                   try {
                    ...
                    String de,si,ola ;
                   de = request.getParameter("correo");
                   si = request.getParameter("contrase");
                   ola = request.getParameter("name");

                    q = "UPDATE pruebadenulo SET correol='"+getMD5(de)+"', contraseña='"+getMD5(si)+"',nombre= '"+de+"'"
                            + "WHERE numusua ='"+session.getAttribute("id")+"'";;
                            
                      o = "select * from pruebadenulo where correol='"+getMD5(de)+"'"; 
