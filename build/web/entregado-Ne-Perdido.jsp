                ...
                con = (Connection)DriverManager.getConnection(url, userName, password);
                        ...
                        try{
                            ...
                            set = con.createStatement();
                             String  q = "INSERT INTO entregado_perdido (titulo,queperdio,foto,lugardeentrega,horario,horapubli,tipo,id_usuario,ene) SELECT  titulo,queperdio,foto,lugarentrega,horario,horapubli,tipo,id_usuario,'si' FROM perdido WHERE idperdido = "+original;  
