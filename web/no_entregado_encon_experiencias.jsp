                ...
                con = (Connection)DriverManager.getConnection(url, userName, password);
                        ...
                        try{
                            ...
                            set = con.createStatement();
                             ...
                             String  per = "INSERT INTO no_entregado_encon_experiencias (titulo,queperdio,dondeloen,pgllave,respuesta,lugar,horario,fechadepubli,tipo,id_usuario,ene,experiencia) SELECT  titulos,queperdios,dondeloens,pglla,respuestas,lugars,horarios,fechadepublis,tipos,id_usuarios,'No','"+sres+"'  FROM entregado_encontrado WHERE id_publi= "+original; 
