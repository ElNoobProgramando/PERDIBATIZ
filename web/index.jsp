             ...
             String buscar = request.getParameter("bu");
                ...
                con = (Connection)DriverManager.getConnection(url, userName, password);
                 ...
                 <div class="rectangulo" id="resultado">  
                   ...
                   <br>
                   <br>
                   <span style=" position:relative; font-size:12px; ; font-weight: bold; top:-70px">&nbsp;&nbsp;&nbsp;Descripcion:<%=rs.getString("queperdio")%></span>
                    <br>
                    ...
                    <br>
                    <span style=" position:relative; font-size:12px; ; font-weight: bold; top:-70px;">&nbsp;&nbsp;&nbsp;<%=rss.getString("queperdio")%></span>
                    <br>
...
$(document).ready(function() {
    ...
    setTimeout(function() {
       ...
       <h1><a href="eleccionpubli.html"> <button style="position: relative; top:-710px; height:40px ; color: white; font-size: 20px; left: 0px; text-transform:uppercase; font-weight: bold; " >Crear Publicacion</button></a></h1>
